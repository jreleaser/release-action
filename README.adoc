...
A custom link:https://github.com/slsa-framework/[SLSA builder] is available for Go projects. The following snippet shows
...
----
  release:
    permissions:
      ...
      actions: read
      packages: write
    uses: jreleaser/release-action/.github/workflows/builder_slsa3.yml@v1.0.0-go
    with:
